...
class PhotoCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        func showNowPhotoAccessAlert() {
            let alert = UIAlertController(title: "No Photo Access Permission", message: "Please grant this App phot access to your photos in Settings --> Privacy", preferredStyle: .alert)
